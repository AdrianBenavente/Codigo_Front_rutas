...
function cargarUbicaciones() {
    fetchAuth("http://localhost:5000/ubicaciones")
...
function mostrarRutasEnMapa() {
    fetchAuth("http://localhost:5000/rutas")
        .then(response => response.json())
        .then(data => {
...
function calcularRuta() {
    ...
    fetchAuth("http://localhost:5000/rutas/agregar", {
        method: "POST",
...
function eliminarRuta(rutaId) {
    fetchAuth(`http://localhost:5000/rutas/eliminar/${rutaId}`, { method: "DELETE" })
        .then(response => response.json())
        .then(data => {
...
function cargarListadoUbicaciones() {
    fetchAuth("http://localhost:5000/ubicaciones_activas")
        .then(response => response.json())
        .then(data => {
        ...
        fetchAuth("http://localhost:5000/ubicaciones_atendidas")
        .then(response => response.json())
        .then(data => {
...
function marcarComoRevisado(ubicacionId) {
    ...
    fetchAuth(`http://localhost:5000/ubicaciones/revisar/${ubicacionId}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
function marcarComoAtendido(ubicacionId, tipoAtencion) {
    ...
    fetchAuth(`http://localhost:5000/ubicaciones/atender/${ubicacionId}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
function restaurarUbicacionRevisada(id) {
    fetchAuth(`http://localhost:5000/restaurar_ubicacion/${id}`, { method: "POST" })
        .then(response => response.json())
        .then(result => {
            alert(result.mensaje);
            cargarListadoUbicaciones();
...
function eliminarUbicacionDefinitiva(id) {
    ...
    fetchAuth(`http://localhost:5000/eliminar_ubicacion/${id}`, { method: "DELETE" })
        .then(response => response.json())
        .then(result => {
            alert(result.mensaje);
            cargarListadoUbicaciones();
...
function marcarUbicacionRevisada(id) {
    ...
    fetchAuth(`http://localhost:5000/ubicaciones/revisar/${id}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
function cargarUsuarios() {
    fetchAuth("http://localhost:5000/usuarios_tabla")
        .then(response => response.json())
        .then(data => {
...
function guardarUsuario() {
    ...
    fetchAuth("http://localhost:5000/usuarios/agregar", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
function eliminarUsuario(id) {
    ...
    fetchAuth(`http://localhost:5000/usuarios/eliminar/${id}`, {
        method: "DELETE"
    })
    .then(response => response.json())
    .then(result => {
...
function actualizarUsuario(id) {
    ...
    fetchAuth(`http://localhost:5000/usuarios/editar/${id}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
